...
<head>
    ...
    <link href="jsp/css/styles.css" rel="stylesheet">
    <link href="jsp/css/animation.css" rel="stylesheet">
    <!-- 返回顶部调用 begin -->
    <link href="jsp/css/lrtk.css" rel="stylesheet" />
    <script type="text/javascript" src="jsp/js/jquery.js"></script>
    <script type="text/javascript" src="jsp/js/js.js"></script>
    <!-- 返回顶部调用 end-->
    <!--[if lt IE 9]>
...
<header>
    <nav id="nav">
        <ul>
            <li><a href="/" >网站首页</a></li>
            <li><a href="/Conncet_db.php/" target="_blank" title="个人博客模板">个人博客模板</a></li>
...
<div id="mainbody">
    <div class="info">
        <figure> <img src="jsp/images/art.jpg"  alt="Panama Hat">
    ...
    <div class="blogs">
        <ul class="bloglist">
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="jsp/images/s1.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="jsp/images/s2.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="jsp/images/s3.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <h2 class="title"><a href="/" target="_blank">谁更心软，谁就先长大</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="jsp/images/s4.jpg"></a>
                        <p> 男人都是孩子，需要用一生时间来长大。女人都想当孩子，却最擅长的角色是妈妈。恋爱一开始，是两个孩子之间的游戏，到后来，成了大人和孩子之间的游戏。恋爱这回事，总要有一个人先长大，对另一半多些包容和宠溺。而通常来看：谁更心软，谁就先长大...</p>
                    </ul>
                    <ul class="details">
                        <li class="likes"><a href="#">102</a></li>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="jsp/images/s5.jpg"></a>
        ...
        <aside>
            ...
            <div class="toppic">
                <h2>图文并茂</h2>
                <ul>
                    <li><a href="/"><img src="jsp/images/k01.jpg">腐女不可怕，就怕腐女会画画！
                            <p>伤不起</p>
                        </a></li>
                    <li><a href="/"><img src="jsp/images/k02.jpg">问前任，你还爱我吗？无限戳中泪点~
                            <p>感兴趣</p>
                        </a></li>
                    <li><a href="/"><img src="jsp/images/k03.jpg">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
                            <p>喜欢</p>
                        </a></li>
                </ul>
            </div>
            ...
            <div class="viny">
                <dl>
                    <dt class="art"><img src="jsp/images/artwork.png" alt="专辑"></dt>
                    ...
                    <dd class="music">
                        <audio src="jsp/images/nf.mp3" controls></audio>
                    </dd>
...
<footer>
    <div class="footer-mid">
        ...
        <section class="flickr">
            <h2>摄影作品</h2>
            <ul>
                <li><a href="/"><img src="jsp/images/01.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/02.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/03.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/04.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/05.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/06.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/07.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/08.jpg"></a></li>
                <li><a href="/"><img src="jsp/images/09.jpg"></a></li>
            </ul>
        </section>
    </div>
